...
data = shuffle [
	...
	{"type":"C7", "question":"내 몸 사진을 인터넷 상에 올려본 적 있거나, 올렸을 때 어떤 반응이 있을지 궁금하거나, 해 본 적 있다", "score":1},
	{"type":"C7", "question":"배달 음식이 도착했을 때, 속옷만 입은 채로 계산하면 흥분될 것 같다", "score":2},
	{"type":"C7", "question":"야외에서 부분, 혹은 전체적인 노출을 해보고 싶다", "score":3},
...
types = {
  ...
  "B7": "공공장소에서 남이 내 몸을 만질 때 흥분을 느낌",
  "A6": "공공장소에서 내가 남의 몸을 만지며 흥분을 느낌",
  "B3": "네토라레",
  "A3": "네토리",
  "C7": "노출을 하며 흥분을 느낌",
  "A1": "돔",
